...
from utils import softmax, rnn_forward, rnn_backward, initialize_parameters, get_initial_loss, smooth, print_sample
...
data = open(os.path.join(PWD, "dinos.txt"), "r").read()
data = data.lower()
chars = list(set(data))
